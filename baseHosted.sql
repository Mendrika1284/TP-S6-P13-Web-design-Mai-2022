...
(null,"cause-bg.jpg","Quelles sont les causes connues du réchauffement climatique?","Quelles sont les causes connues du réchauffement climatique?"),
(null,"cons-bg.jpg","Quelles sont les conséquences de ce réchauffement climatique?","Quelles sont les conséquences de ce réchauffement climatique?"),
(null,"solution-bg.jpg","Les solutions envisagées contre le réchauffement climatique?","Les solutions envisagées contre le réchauffement climatique?");

UPDATE Question SET
    url = replace(trim(lower(question)), ' ', '-');
...
UPDATE Consequence SET
    url = replace(trim(lower(titre)), ' ', '-');
